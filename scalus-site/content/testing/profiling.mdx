...
- **[JS/TS Profiling](/docs/testing/js-emulator#profiling-a-script)** — Generate the same HTML report from JavaScript/TypeScript with `Scalus.evaluateScriptProfile`
